...
public final class NewsTest {
    ...
    public void shouldThrowException_whenAuthorIsNull() {
        new News("ARTICLEID1", Instant.now(), null, "Hello world", "hello-world", "Desc", "Content", null, null, NewsStatus.DRAFT);
    }

    @Test
    public void shouldAssignAnAuthor() {
        News news = new News("ARTICLEID1", Instant.now(), "john", "Hello world", "hello-world", "Desc", "Content", null, null, NewsStatus.DRAFT);
    ...
    public void shouldThrowException_whenContentIsNull() {
        new News("ARTICLEID1", Instant.now(), "author", "Hello world", "hello-world", "Desc", null, null, null, NewsStatus.DRAFT);
    }
    ...
    public void shouldAssignASource() {
        News news = new News("ARTICLEID1", Instant.now(), "john", "Hello world", "hello-world", "Desc", "Content", "https://google.com", null, NewsStatus.DRAFT);
    ...
    public void shouldBeComparedOnCreationDate() {
        News news1 = new News("ARTICLEID1", Instant.now(), "john", "Hello world", "hello-world", "Desc", "Content", null, null, NewsStatus.DRAFT);
        News news2 = new News("ARTICLEID2", Instant.now().plus(10, ChronoUnit.SECONDS), "john", "Hello world", "hello-world", "Desc", "Content", null, null, NewsStatus.DRAFT);
