package com.blebail.components.webservices.fixtures;
...
public final class JavaFixtures {
    ...
    public static Operation uuidResources() {
        return sequenceOf(
            Operations.deleteAllFrom("uuid_resource"),
            Operations.insertInto("uuid_resource")
