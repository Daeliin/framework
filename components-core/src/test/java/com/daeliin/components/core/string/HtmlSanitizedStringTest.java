...
public final class HtmlSanitizedStringTest {

    @Test
    public void shouldRemoveScriptTag_byDefault() {
        String input = "Test<script>alert('ok');</script>";

        assertThat(new HtmlSanitizedString(input).value).isEqualTo("Test");
    }
    ...
    public void shouldRemoveAnyHtmlTag_byDefault() {
        ...
        assertThat(new HtmlSanitizedString(input).value).isEqualTo("This is a test");
    }
    ...
    public void shouldAllowRawLinks_byDefault() {
        ...
        assertThat(new HtmlSanitizedString(input).value).isEqualTo("https://www.google.com");
    }
    ...
    public void shouldAllowHtmlLink_whenWhitelisted() {
        ...
        assertThat(new HtmlSanitizedString(input, new Whitelist().addAttributes("a", "id", "class", "href", "target").addTags("a")).value).isEqualTo(input);
    }
}